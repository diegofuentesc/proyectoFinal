...
const EditarPublicacion = () => {
  ...
  return (
    <Container className="formEditar">
      ...
      <Form className="contenidoFormIngresar" onSubmit={actualizarPublicacion}>
        ...
        <Form.Group className="mb-3" controlId="combustible">
          ...
          <Form.Select value={combustible} onChange={(e) => setCombustible(e.target.value)}>
        ...
        <Form.Group className="mb-3" controlId="transmision">
          ...
          <Form.Select value={transmision} onChange={(e) => setTransmision(e.target.value)}>
            <option value="">Seleccione el tipo de transmision</option>
            <option value="Automatico">Automatico</option>
            <option value="Manual">Mnual</option>
          </Form.Select>
          </Form.Group>
          <Form.Group className="mb-3" controlId="estado">
          <Form.Label>Tipo Condicion</Form.Label>
          <Form.Select value={estado} onChange={(e) => setEstado(e.target.value)}>
            <option value="">Seleccione el estado</option>
            <option value="Diesel">Nuevo</option>
            <option value="Bencina">Usado</option>
          </Form.Select>
          </Form.Group>

        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          <Nav className='navPrivado'>
            {usuario.conectado &&
              <>
                ...
                <NavDropdown className='menu' title={<span><img src={`../avatar/${usuario.avatar}.png`} alt="Avatar seleccionado" className="avatar-img" />{usuario.nombre} {usuario.apellido}</span>} id="nav-dropdown">
                  <NavDropdown.Item>
          ...
          <Form className="d-flex">
            {usuario.conectado ?
              ...
              (<NavLink to='/'><Button className='btnBarraCerrar' onClick={cerrarSesion}><RiLogoutBoxRLine></ RiLogoutBoxRLine></Button></NavLink>) :
              (<>
